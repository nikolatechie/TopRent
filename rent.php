...
<html>
	<head>
		<title>TopRent - Rent a car</title>
	...
	<body>
		...
		<form id="rent-form" method="GET">
			<h2>Adjust filters to find the ideal car.</h2>
			...
			<div class="form-group" id="filter">
				<div>
					...
					<select id="car-brand" name="car-brand">
						<option value="ALL" default>All brands</option>
				...
				<div class="filter-part">
					<div class="filter-label">
						<label>Fuel consumption/100 km:</label>
					</div>
				...
				<div class="filter-part">
					<div class="filter-label">
						<label>Price per hour (EUR):</label>
					</div>
				...
				<input type="submit" id="search" name="search" class="btn btn-primary" name="search" value="Search">
			</div>
		</form>
					...
					echo   "<div class='col-md-4'>
								<form method='POST'>
									<div class='card' style='width: 18rem;'>
										...
										<div class='card-body'>
									    	<p class='card-text'>$row[brand] $model ($row[year_produced])<br>Fuel consumption/100 km: $row[fuel_consumption]L<br>Price per hour: $row[price_per_hour]€<br>Price per day: $row[price_per_day]€</p>

									    	<button type='submit' id='btn-rent' name='btn-rent' value='$model'>Rent</button>
									  	</div>
									</div>
								</form>
							</div>";
